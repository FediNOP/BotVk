...
public class API {
    ...
    private String URL = "https://api.vk.com/method/", V = "&v=" + 5.68;
    ...
    public JSONArray execute(CallSync... calls) {
        ...
        response = new JSONObject(callSync("execute", new JSONObject().put("code", URLEncoder.encode(code.toString(), StandardCharsets.UTF_8))));
